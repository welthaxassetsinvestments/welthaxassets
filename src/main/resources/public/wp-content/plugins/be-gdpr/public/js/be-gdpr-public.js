  ...
  $(function () {
        ...
        if (isJSON(gdprData)) {
          ...
          if (!hasConcern(concern)) {
            if (typeof gdprData.remove === "object") {
              classesToRemove = gdprData.remove.class
                ? gdprData.remove.class
                : [];
      ...
      itemsToReplaceContent.each(function (i, e) {
        ...
        if (hasConcern(concern)) {
          ...
          if (replaceTarget === "parent") {
            ...
            var replacingContent = $(this).siblings(
              ".be-gdpr-consent-message "
            );
    ...
    function gdprSaveBtnClick(e) {
      ...
      var checkBoxes = $(e.target)
        .closest(".be-gdpr-modal")
        .find(".be-gdpr-switch-input");
      for (var count in checkBoxes) {
        var singleCheckBox = checkBoxes[count];
