  ...
  var u,
    ...
    b = function (e, t, i, n) {
      ...
      return (
        (o.className = "mfp-" + e),
        i && (o.innerHTML = i),
        n ? t && t.appendChild(o) : ((o = d(o)), t && o.appendTo(t)),
        o
      );
    },
    I = function (e, t) {
      u.ev.triggerHandler(i + e, t),
        u.st.callbacks &&
          ((e = e.charAt(0).toLowerCase() + e.slice(1)),
          u.st.callbacks[e] &&
            u.st.callbacks[e].apply(u, d.isArray(t) ? t : [t]));
    },
    x = function (e) {
      return (
        (e === t && u.currTemplate.closeBtn) ||
          ((u.currTemplate.closeBtn = d(
    ...
    k = function () {
      d.magnificPopup.instance ||
        ((u = new e()).init(), (d.magnificPopup.instance = u));
    };
  (e.prototype = {
    constructor: e,
    init: function () {
    ...
    open: function (e) {
      ...
      if (!u.isOpen) {
        (u.types = []),
          ...
          e.key
            ? (u.popupsCache[e.key] || (u.popupsCache[e.key] = {}),
              (u.currTemplate = u.popupsCache[e.key]))
            : (u.currTemplate = {}),
          ...
          u.bgOverlay ||
            ((u.bgOverlay = b("bg").on("click" + v, function () {
              u.close();
            })),
            (u.wrap = b("wrap")
              .attr("tabindex", -1)
          ...
          u.st.preloader &&
            (u.preloader = b("preloader", u.container, u.st.tLoading));
        ...
        I("BeforeOpen"),
          ...
          u.fixedContentPos
            ...
            : u.wrap.css({ top: C.scrollTop(), position: "absolute" }),
          (!1 === u.st.fixedBgPos ||
            ("auto" === u.st.fixedBgPos && !u.fixedContentPos)) &&
            u.bgOverlay.css({ height: p.height(), position: "absolute" }),
          u.st.enableEscapeKey &&
            p.on("keyup" + v, function (e) {
        ...
        return (
          ...
          setTimeout(function () {
            u.content
              ? (u._addClassToMFP(h), u._setFocus())
              : u.bgOverlay.addClass(h),
              p.on("focusin" + v, u._onFocusIn);
          }, 16),
          (u.isOpen = !0),
          u.updateSize(a),
          I(g),
    ...
    updateItemHTML: function () {
      ...
      var t = e.type;
      if (
        (I("BeforeChange", [u.currItem ? u.currItem.type : "", t]),
        (u.currItem = e),
        !u.currTemplate[t])
      ) {
      ...
      var n = u["get" + t.charAt(0).toUpperCase() + t.slice(1)](
        e,
        u.currTemplate[t]
      );
      u.appendContent(n, t),
    ...
    appendContent: function (e, t) {
      (u.content = e)
        ? u.st.showCloseBtn && u.st.closeBtnInside && !0 === u.currTemplate[t]
          ? u.content.find(".mfp-close").length || u.content.append(x())
          : (u.content = e)
        : (u.content = ""),
        I("BeforeAppend"),
    ...
    _hasScrollBar: function (e) {
      return (
        (u.isIE7 ? p.height() : document.body.scrollHeight) > (e || C.height())
      );
    },
    _setFocus: function () {
    ...
    _onFocusIn: function (e) {
      return e.target === u.wrap[0] || d.contains(u.wrap[0], e.target)
        ? void 0
        : (u._setFocus(), !1);
    },
            ...
            if (0 < i.length) {
              ...
              "replaceWith" === n
                ...
                ? i.is("img")
                  ? i.attr("src", t)
                  : i.replaceWith(
                      d("<img>").attr("src", t).attr("class", i.attr("class"))
                    )
                : i.attr(r[1], t);
            }
    ...
    (d.fn.magnificPopup = function (e) {
      ...
      if ("string" == typeof e)
        if ("open" === e) {
          ...
          (i = n.items
            ? n.items[o]
            : ((i = t), n.delegate && (i = i.find(n.delegate)), i.eq(o))),
            u._openClick({ mfpEl: i }, t, n);
        } else
          u.isOpen && u[e].apply(u, Array.prototype.slice.call(arguments, 1));
      else
        (e = d.extend(!0, {}, e)),
          y ? t.data("magnificPopup", e) : (t[0].magnificPopup = e),
          u.addGroup(t, e);
      return t;
    });
  var T,
        ...
        if ((E(), e.src)) {
          ...
          if (n.length) {
            ...
            o &&
              ...
              (P = n.after(_).detach().removeClass(T))),
          ...
          n = function () {
            e &&
              (e.img[0].complete
                ? (e.img.off(".mfploader"),
                  e === u.currItem &&
                    (u._onImageHasSize(e), u.updateStatus("ready")),
                  (e.hasSize = !0),
                  (e.loaded = !0),
                  I("ImageLoadComplete"))
                : ++i < 200
            ...
            ? (L && clearInterval(L),
              e.loadError
                ? (t.addClass("mfp-loading"),
                  u.updateStatus("error", r.tError.replace("%url%", e.src)))
                : (t.removeClass("mfp-loading"), u.updateStatus("ready")))
          ...
          var i,
            ...
            a = function (e) {
              var t = e
                ...
                o = "transition";
              return (
                (n["-webkit-" + o] = n["-moz-" + o] = n["-o-" + o] = n[o] = i),
                t.css(n),
                t
              );
            },
            ...
            w("BuildControls" + e, function () {
              if (1 < u.items.length && r.arrows && !u.arrowLeft) {
                var e = r.arrowMarkup,
                  ...
                  i = (u.arrowRight = d(
                    e.replace(/%title%/gi, r.tNext).replace(/%dir%/gi, "right")
                  ).addClass(s));
                t.click(function () {
                  u.prev();
                }),
